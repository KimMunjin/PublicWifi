...
<body>
	<script>
		function editGroupMark(){
			var bookId = document.getElementById("bookId").value;
			var bookName = document.getElementById("bookName").value;
			var bookOrder =document.getElementById("bookOrder").value;
			
			var url = 'bookmark-group-edit-submit.jsp?bookId='+bookId+'&bookName=' + bookName + '&bookOrder=' + bookOrder;
		...
		<tbody>
			...
			<tr>
				...
				<td colspan="2" style="text-align: center;">
					<a href="bookmark-group.jsp">돌아가기</a> | <input type="button" value="수정" onclick="editGroupMark()">
				</td>
			</tr>
		</tbody>
	</table>
